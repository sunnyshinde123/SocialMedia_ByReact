export default function Sidebar({handleState, state}){
    return (
        <>
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark sidebar" style={{width: "280px"}}>
            ...
            <li class="nav-item" onClick={()=> handleState("Home")}>
                <a href="#" class={`nav-link text-white ${state=="Home" && 'active'}`} aria-current="page">
                <svg class="bi pe-none me-2" width="16" height="16"><use xlinkHref="#home"></use></svg>
                Home
                </a>
            </li>
            <li onClick={()=> handleState("Create Post")}>
                <a href="#" class={`nav-link text-white ${state=="Create Post" && 'active'}`}>
